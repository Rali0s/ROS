...
export const SHELL_THEMES = {
  ...
  red_black_glass: {
    ...
    name: 'Black Falcon',
    shortName: 'BF',
    accentLabel: 'Red Black Glass',
    bg: 'bg-[#090506]',
    windowBg: 'bg-[rgba(12,5,6,0.90)]',
    panelBg: 'bg-[rgba(24,8,10,0.64)]',
    border: 'border-red-500/18',
    borderStrong: 'border-red-300/26',
    accentText: 'text-red-100',
    accentChip: 'border-red-300/20 bg-red-500/12 text-red-100',
    launcherHover: 'hover:border-red-300/24',
    launcherSelected: 'border-red-300/28 bg-red-500/12',
    lockButton: 'border-red-300/20 bg-red-500/12 text-red-100 hover:bg-red-500/20',
    shellBadge: 'border-red-300/20 bg-red-500/12 text-red-100',
    iconTone: 'border-red-300/25 bg-red-500/12 text-red-100 shadow-red-950/20',
  },
  cypher: {
    id: 'cypher',
    name: 'Cypher Citadel',
...
export const APP_INTERIOR_THEMES = {
  ...
  red_black_glass: {
    pageBg: 'bg-[#090506]',
    sidebarBg: 'bg-[rgba(18,6,8,0.82)]',
    sidebarBorder: 'border-red-500/18',
    panelBg: 'bg-[rgba(16,8,10,0.74)]',
    panelBorder: 'border-red-500/18',
    panelMutedBg: 'bg-white/[0.045]',
    panelMutedBorder: 'border-white/10',
    heroBg:
      'bg-[linear-gradient(135deg,rgba(127,29,29,0.24),rgba(14,6,8,0.78)_58%,rgba(5,5,5,0.92)_100%)]',
    heroBorder: 'border-red-300/24',
    heroPill: 'border-red-300/20 bg-red-500/12 text-red-100',
    accentText: 'text-red-100',
    accentSoftText: 'text-slate-300',
    input:
      'border-red-300/16 bg-black/35 text-red-50 placeholder:text-slate-600 focus:border-red-300/40 focus:bg-black/45',
    primaryButton: 'bg-red-500 text-white hover:bg-red-400',
    primaryButtonSoft: 'border-red-300/22 bg-red-500/12 text-red-100 hover:bg-red-500/20',
    secondaryButton: 'border-white/12 bg-white/[0.055] text-slate-200 hover:bg-white/[0.09]',
    activeChip: 'bg-red-500 text-white',
    inactiveChip: 'bg-white/[0.045] text-slate-300 hover:bg-red-500/12 hover:text-red-50',
    selectedCard: 'border-red-300/28 bg-red-500/12',
    card: 'border-white/10 bg-white/[0.045] hover:border-red-300/24 hover:bg-red-500/10',
    tag: 'border-red-300/18 bg-red-500/10 text-red-100',
    linkCard: 'border-red-300/18 bg-red-500/10 text-red-100 hover:bg-red-500/18',
    previewBg: 'bg-black/35',
    headingAccent: 'text-white',
    bulletAccent: 'bg-red-300',
    codeAccent: 'text-red-100',
  },
  cypher: {
    pageBg: 'bg-[#03080b]',
...
export const APPS = {
  ...
  'black-falcon': {
    ...
    title: '[ Black Falcon ]',
    icon: ShieldAlert,
    component: 'BlackFalconConnectorApp',
    description: 'Mock-first Falcon Spotlight connector for CISA scoring and DNS remediation planning.',
    category: 'security',
    doctrine: 'signal',
    defaultSize: roomyWindow(1620, 940),
    defaultFrame: { w: 1620, h: 940 },
    iconTone: 'border-red-400/25 bg-red-500/10 text-red-100 shadow-red-950/20',
  },
  'control-room': {
    id: 'control-room',
    title: 'Control Room',
